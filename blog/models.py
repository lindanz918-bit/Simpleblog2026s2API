...
class BaseModel(models.Model):
    created_at = models.DateTimeField(auto_now_add=True) # you can not change
    updated_at = models.DateTimeField(auto_now=True)  #you can change
...
class Post(models.Model):
    ...
    body = RichTextField()
    post_date = models.DateTimeField(auto_now_add=True)   ## auto_now_add=True means the date will be set when the object is first created
